...
const Start = "Привіт, друже!\n\nЯ допоможу тобі вивчити наголоси, які треба знати для того, щоб скласти ЗНО з української " +
	"мови на всі 200! 😸"

const SomethingWentWrong = "<b>😿 Ой-йой!</b>\n\nЗдається, щось пішло не так."

const MainMenu = "<b>🏠 Головне меню</b>\n\n🆒 Напиши мені слово, а я вкажу який у ньому наголос (якщо воно є у " +
	"затвердженому переліку).\n<b>Ти: </b><i>фольга</i>\n<b>Я: </b><i>фОльга</i>\n\n🔠 Напиши мені букву " +
	"або кілька букв через пробіл, щоб побачити усі наголоси на цю літеру.\n<b>Ти: </b><i>Є Я</i>\n<b>Я: </b>" +
	"<i>єретИк\nярмаркОвий</i>"

const PracticeMenu = "<b>🎯 Практика</b>\n\nОбери кількість слів для самоперевірки."

const PracticeExplanation1 = "<b>%s? Чудовий вибір!</b>\n\nГаразд, зараз я надсилатиму тобі по одному слову, " +
	"написаному маленькими літерами, а ти обиратимеш правильний наголос (він позначається великою літерою) на " +
	"клавіатурі."
